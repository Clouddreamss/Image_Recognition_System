        ...
        <el-container>
            ...
            <el-aside width="150px">
                <el-menu default-active="1" class="el-menu-vertical-demo">
                    ...
                    <el-menu-item index="2">历史管理</el-menu-item>
            ...
            <el-main>
                ...
                >
                    ...
                    <el-table-column label="板件id" prop="id">
                    </el-table-column>
                    <el-table-column label="清洗时间" prop="date">
                    </el-table-column>
                    <el-table-column label="清洗率" prop="rate">
                    </el-table-column>
                    <el-table-column label="清洗情况" prop="status">
                    </el-table-column>
                ...
                >
                    ...
                    <div slot="footer" class="dialog-footer">
                        <el-button @click="dialogVisible = false"
                            >取 消</el-button
                        >
                        <el-button type="primary" @click="reWash()"
                            >处理</el-button
                        >
                    </div>
                </el-dialog>
